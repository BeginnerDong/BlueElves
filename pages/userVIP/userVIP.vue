<template>
	<view>
		...
		<view class="userHead whiteBj pdb15">
			...
			<view class="" style="width: 720rpx;height: 150rpx;" @click="Router.navigateTo({route:{path:'/pages/user_vipEquity/user_vipEquity'}})"><image src="../../static/images/about-img-01.png" mode=""></image></view>
		</view>
		...
		<view class="pdlr4 mgt15">
			<view class="userBox2 boxShaow radius10 whiteBj pdlr4">
				<view class="flexRowBetween pdt15 pdb10 borderB1">
					...
					<view class="more flexEnd fs12 color9" @click="Router.navigateTo({route:{path:'/pages/userVIP-order/userVIP-order'}})">全部订单<image class="arrowR" src="../../static/images/about-icon-1.png" mode=""></image></view>
				</view>
				<view class="flexRowBetween fs12 pdt20 center">
					<view class="item" @click="Router.navigateTo({route:{path:'/pages/userVIP-order/userVIP-order?num=2'}})">
						<view class="icon">
							<image src="../../static/images/about-icon2.png"></image>
						</view>
						<view>待处理</view>
					</view>
					<view class="item" @click="Router.navigateTo({route:{path:'/pages/userVIP-order/userVIP-order?num=3'}})">
						<view class="icon">
							<image src="../../static/images/about-icon3.png"></image>
						</view>
						<view>待发货</view>
					</view>
					<view class="item" @click="Router.navigateTo({route:{path:'/pages/userVIP-order/userVIP-order?num=4'}})">
						<view class="icon">
							<image src="../../static/images/about-icon4.png"></image>
						</view>
						<view>已发货</view>
					</view>
					<view class="item" @click="Router.navigateTo({route:{path:'/pages/userVIP-order/userVIP-order?num=5'}})">
						<view class="icon">
							<image src="../../static/images/about-icon5.png"></image>
						</view>
						<view>已完成</view>
					</view>
					<view class="item" @click="Router.navigateTo({route:{path:'/pages/userVIP-order/userVIP-order?num=6'}})">
						<view class="icon">
							<image src="../../static/images/about-icon5.png"></image>
						</view>
						<view>已退货</view>
		...
		<view class="pdlr4 mgt15">
			<view class="userBox2 boxShaow radius10 whiteBj pdlr4">
				...
				<view class="menu flex fs12 pdt20 center">
					...
					<view class="item" @click="Router.navigateTo({route:{path:'/pages/userVIP-myAssess/userVIP-myAssess'}})">
						<view class="icon">
					...
					<view class="item" @click="Router.navigateTo({route:{path:'/pages/userVIP-data/userVIP-data'}})">
						<view class="icon">
