		...
		<view class="pdlr4 mgt15">
			<view class="userBox2 boxShaow radius10 whiteBj pdlr4">
				...
				<view class="flexRowBetween fs12 pdt20 center">
					<view class="item" @click="Router.navigateTo({route:{path:'/pages/userVIP-order/userVIP-order'}})">
						<view class="icon">
					...
					<view class="item" @click="Router.navigateTo({route:{path:'/pages/userVIP-returnGoodsOrder/userVIP-returnGoodsOrder'}})">
						<view class="icon">
							<image src="../../static/images/about-icon5.png"></image>
						</view>
						<view>已退货</view>
